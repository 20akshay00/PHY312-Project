...
| | |
| ----------- | ----------- |
|![](./images/data/PVDF_750mic/DeltaFn/stresss.gif){ width=100% }|![](./images/data/PVDF_750mic/DeltaFn/chargee.gif){ width=100% }|
...
| | |
| ----------- | ----------- |
|![](./images/data/PVDF_750mic/DeltaFn/AvCharge.png){ width=100% }|![](./images/data/PVDF_750mic/DeltaFn/AvPotential.png){ width=100% }|

# Results (Part 2)

## PZT-5A, 150 micron 

### Step load: R $\in$ ($10^5\Omega$ $\rightarrow$ $10^{10} \Omega$) 
| | | |
| ----------- | ----------- | ----------- |
|![Stress](./images/CircuitData/PZT_150_Step/r5.png){ width=100% }| ![Potential](./images/CircuitData/PZT_150_Step/r6.png){ width=100% }| ![Potential](./images/CircuitData/PZT_150_Step/r7.png){ width=100% }|
|![Stress](./images/CircuitData/PZT_150_Step/r8.png){ width=100% }| ![Potential](./images/CircuitData/PZT_150_Step/r9.png){ width=100% }| ![Potential](./images/CircuitData/PZT_150_Step/r10.png){ width=100% }|

## PZT-5A, 150 micron 

### Gaussian load: R $\in$ ($10^5\Omega$ $\rightarrow$ $10^{10} \Omega$) 
| | | |
| ----------- | ----------- | ----------- |
|![Stress](./images/CircuitData/PZT_150_Delta/r5.png){ width=100% }| ![Potential](./images/CircuitData/PZT_150_Delta/r6.png){ width=100% }| ![Potential](./images/CircuitData/PZT_150_Delta/r7.png){ width=100% }|
|![Stress](./images/CircuitData/PZT_150_Delta/r8.png){ width=100% }| ![Potential](./images/CircuitData/PZT_150_Delta/r9.png){ width=100% }| ![Potential](./images/CircuitData/PZT_150_Delta/r9.png){ width=100% }|

## PVDF, 150 micron 

### Step load: R $\in$ ($10^5\Omega$ $\rightarrow$ $10^7 \Omega$) 
| | | |
| ----------- | ----------- | ----------- |
|![Stress](./images/CircuitData/PVDF_150_Step/r5.png){ width=100% }| ![Potential](./images/CircuitData/PVDF_150_Step/r6.png){ width=100% }| ![Potential](./images/CircuitData/PVDF_150_Step/r7.png){ width=100% }|

## PVDF, 150 micron 

### Gaussian load: R $\in$ ($10^3\Omega$ $\rightarrow$ $10^5 \Omega$) 
| | | |
| ----------- | ----------- | ----------- |
|![Stress](./images/CircuitData/PVDF_150_Delta/r3.png){ width=100% }| ![Potential](./images/CircuitData/PVDF_150_Delta/r4.png){ width=100% }| ![Potential](./images/CircuitData/PVDF_150_Delta/r5.png){ width=100% }|
